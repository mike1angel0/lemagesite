...
export default function AdminEditorNewPage() {
  ...
  const defaultPrompts: Record<string, string> = {
    Poetry: `Minimalist ink and watercolor illustration for "{TITLE}". {SUMMARY}. Sparse, elegant line drawing with selective washes of color. A human figure rendered with expressive flowing ink strokes. Limited palette: deep navy (#0B0E13) ink lines, warm gold (#C9A962) and honey amber (#C8944A) watercolor washes, steel blue (#A8B4C8) subtle accents, warm ivory (#F5EED8) negative space. Lots of white/ivory breathing room. Poetic, contemplative, minimal. No text, no watermarks, no color swatches. Fill entire frame.`,
    Essay: `Minimalist editorial illustration for "{TITLE}". {SUMMARY}. Clean ink drawing with subtle watercolor accents. A human figure in an elegant, spare composition. Limited palette: deep navy (#0B0E13) ink, warm gold (#C9A962) and honey amber (#C8944A) color accents, steel blue (#A8B4C8) washes, warm ivory (#F5EED8) background. Thoughtful, refined, minimal. No text, no watermarks, no color swatches. Fill entire frame.`,
    Research: `Minimalist conceptual illustration for "{TITLE}". {SUMMARY}. Precise ink line drawing with restrained watercolor highlights. A human figure in an intellectual, contemplative scene. Limited palette: deep navy (#0B0E13) lines, warm gold (#C9A962) accents, steel blue (#A8B4C8) tones, ivory (#F5EED8) space. Sophisticated, sparse, poetic. No text, no watermarks, no color swatches. Fill entire frame.`,
  };

...
export default function AdminEditorNewPage() {
  ...
  const defaultPrompts: Record<string, string> = {
    Poetry: `Cinematic fine art portrait photograph for "{TITLE}". {SUMMARY}. Dreamy, poetic atmosphere with soft bokeh and gentle haze. Color grading: dominant warm gold (#C9A962) and honey amber (#C8944A) in the light, deep navy (#0B0E13) in shadows, warm ivory (#F5EED8) skin tones and highlights, steel blue (#A8B4C8) accents. The human subject has a realistic face with natural skin texture. Shallow depth of field, 85mm lens. Mood: tender, hopeful, lyrical. No text, no watermarks, no color swatches. Fill entire frame edge-to-edge.`,
    Essay: `Cinematic editorial portrait photograph for "{TITLE}". {SUMMARY}. Elegant, contemplative atmosphere with soft warm light. Color grading: warm gold (#C9A962) and honey amber (#C8944A) highlights, deep navy (#0B0E13) shadows, warm ivory (#F5EED8) tones, steel blue (#A8B4C8) accents. The human subject has a realistic face with natural skin texture. Clean composition, 50mm lens. Mood: thoughtful, refined, quietly optimistic. No text, no watermarks, no color swatches. Fill entire frame edge-to-edge.`,
    Research: `Cinematic portrait photograph for "{TITLE}". {SUMMARY}. Sophisticated atmosphere with purposeful lighting. Color grading: deep navy (#0B0E13) dominant, warm gold (#C9A962) accent light, honey amber (#C8944A) warmth, ivory (#F5EED8) highlights, steel blue (#A8B4C8) tones. The human subject has a realistic face with natural skin texture. 35mm lens. Mood: contemplative, intellectual, poetic. No text, no watermarks, no color swatches. Fill entire frame edge-to-edge.`,
  };

...
export default function AdminEditorNewPage() {
  ...
  const defaultPrompts: Record<string, string> = {
    ...
    Essay: `Cute, thoughtful editorial illustration for "{TITLE}". {SUMMARY}. Clean ink drawing with warm watercolor washes. A whimsical abstract human silhouette or symbolic figure — playful and inviting. Warm palette: honey gold (#C9A962), soft amber (#C8944A), warm ivory (#F5EED8) as dominant tones, steel blue (#A8B4C8) accents, deep navy (#0B0E13) for details. Light and optimistic mood with gentle, charming details. CRITICAL: The illustration must fill the ENTIRE frame edge-to-edge with no white space, no margins, no empty borders. No text, no watermarks, no color swatches.`,
    Research: `Cute, refined conceptual illustration for "{TITLE}". {SUMMARY}. Precise ink lines with warm watercolor highlights and playful touches. An abstract human form — a whimsical silhouette or gestural shape suggesting a person. Warm palette: honey gold (#C9A962), soft amber (#C8944A), warm ivory (#F5EED8) as dominant tones, steel blue (#A8B4C8) accents, navy (#0B0E13) for linework. Sophisticated yet charming and bright. CRITICAL: The illustration must fill the ENTIRE frame edge-to-edge with no white space, no margins, no empty borders. No text, no watermarks, no color swatches.`,
  };
